...
public class Main extends Application {
    ...
    public Group printSample(LedsBoard ledsBoard) {
        ...
        //this will contain two VBox and each VBox have labels with arrayish element
        HBox hBox = new HBox();
        VBox vBox1 = new VBox();
        VBox vBox2 = new VBox();
        ...
        for (int i = 0; i < buttonLED.length; i++) {
            ...
            if (i < 10) {
                ...
                //helps.ledsBoard.getLeds().get(i).setLayoutX(buttonLED[i].getLayoutX());
                ...
                //if the element more than 15 then just show the result and break the loop
                break;
            }
        }
